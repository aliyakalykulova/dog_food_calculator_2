                          ...
                          if st.session_state.show_result_2:
                              ...
                              if res.success:
                                  ...
                                  for k, v in nutrients.items():
                                      k = nutrients_transl.loc[nutrients_transl["name_in_database"] == k,"name_ru"].iloc[0].split(",")[0]
                                  ...
                                  if best_recipe:
                                    ...
                                    st.markdown("### 💪 Питательная ценность на 100 г:")
                                    for nutr in main_nutrs:
                                        nutr=nutrients_transl.loc[nutrients_transl["name_in_database"] == nutr,"name_ru"].iloc[0].split(",")[0]
